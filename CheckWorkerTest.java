...
@Slf4j
public class CheckWorkerTest implements java.io.Serializable, Callable<String> {
    ...
    public CheckWorkerTest(List<Long> checkTaskIds, JdbcTemplate jdbcTemplate, IndicatorService indicatorService,
