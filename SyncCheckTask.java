...
/**
 * the nanfei hub data check tool
 * created by chengch
 * 2019-10-10
 * email: chengchx@inspur.com
 *
 */
public class SyncCheckTask {
    ...
    public static void main(String[] args) {
        ...
        SyncCheckTask testMain = context.getBean(SyncCheckTask.class);

        Properties properties = new Properties();
        try {
            properties.load(SyncCheckTask.class.getClassLoader().getResourceAsStream("dataBase.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        if (true) {
            ...
            for (String groupKey : groupByKey.keySet()) {
                ...
                Future<String> future = exec
                        .submit(new CheckWorker(checkTaskIds, testMain.jdbcTemplate, testMain.indicatorService,
